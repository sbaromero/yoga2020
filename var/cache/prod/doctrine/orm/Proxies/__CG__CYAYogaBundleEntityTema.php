 ...
 */
class Tema extends \CYA\YogaBundle\Entity\Tema implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'materia', '' . "\0" . 'CYA\\YogaBundle\\Entity\\Tema' . "\0" . 'id', '' . "\0" . 'CYA\\YogaBundle\\Entity\\Tema' . "\0" . 'titulo', '' . "\0" . 'CYA\\YogaBundle\\Entity\\Tema' . "\0" . 'comentario'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Tema $proxy) {
