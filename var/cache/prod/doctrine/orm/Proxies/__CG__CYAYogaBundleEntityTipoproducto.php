 ...
 */
class Tipoproducto extends \CYA\YogaBundle\Entity\Tipoproducto implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'productos', '' . "\0" . 'CYA\\YogaBundle\\Entity\\Tipoproducto' . "\0" . 'id', '' . "\0" . 'CYA\\YogaBundle\\Entity\\Tipoproducto' . "\0" . 'descripcion'];
        }
