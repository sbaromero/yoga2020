...
class Tipocuota extends \CYA\YogaBundle\Entity\Tipocuota implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'usuarios', '' . "\0" . 'CYA\\YogaBundle\\Entity\\Tipocuota' . "\0" . 'id', '' . "\0" . 'CYA\\YogaBundle\\Entity\\Tipocuota' . "\0" . 'nombre', '' . "\0" . 'CYA\\YogaBundle\\Entity\\Tipocuota' . "\0" . 'valor', '' . "\0" . 'CYA\\YogaBundle\\Entity\\Tipocuota' . "\0" . 'escurso'];
        }
