 ...
 */
class Caja extends \CYA\YogaBundle\Entity\Caja implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'CYA\\YogaBundle\\Entity\\Caja' . "\0" . 'id', '' . "\0" . 'CYA\\YogaBundle\\Entity\\Caja' . "\0" . 'fecha', '' . "\0" . 'CYA\\YogaBundle\\Entity\\Caja' . "\0" . 'monto'];
        }
