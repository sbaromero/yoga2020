 ...
 */
class Auxiliarventa extends \CYA\YogaBundle\Entity\Auxiliarventa implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'producto', '' . "\0" . 'CYA\\YogaBundle\\Entity\\Auxiliarventa' . "\0" . 'id', '' . "\0" . 'CYA\\YogaBundle\\Entity\\Auxiliarventa' . "\0" . 'cantidad', '' . "\0" . 'CYA\\YogaBundle\\Entity\\Auxiliarventa' . "\0" . 'monto'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Auxiliarventa $proxy) {
