 ...
 */
class Cursada extends \CYA\YogaBundle\Entity\Cursada implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'materia', 'usuario', '' . "\0" . 'CYA\\YogaBundle\\Entity\\Cursada' . "\0" . 'id', '' . "\0" . 'CYA\\YogaBundle\\Entity\\Cursada' . "\0" . 'nota', '' . "\0" . 'CYA\\YogaBundle\\Entity\\Cursada' . "\0" . 'comentario', '' . "\0" . 'CYA\\YogaBundle\\Entity\\Cursada' . "\0" . 'fechains'];
        }
