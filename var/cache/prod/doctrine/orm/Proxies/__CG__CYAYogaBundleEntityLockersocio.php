 ...
 */
class Lockersocio extends \CYA\YogaBundle\Entity\Lockersocio implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'locker', 'usuario', '' . "\0" . 'CYA\\YogaBundle\\Entity\\Lockersocio' . "\0" . 'id', '' . "\0" . 'CYA\\YogaBundle\\Entity\\Lockersocio' . "\0" . 'fechainicio', '' . "\0" . 'CYA\\YogaBundle\\Entity\\Lockersocio' . "\0" . 'comentario'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Lockersocio $proxy) {
