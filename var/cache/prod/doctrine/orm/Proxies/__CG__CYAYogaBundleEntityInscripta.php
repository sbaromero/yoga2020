 ...
 */
class Inscripta extends \CYA\YogaBundle\Entity\Inscripta implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'materia', 'usuario', '' . "\0" . 'CYA\\YogaBundle\\Entity\\Inscripta' . "\0" . 'id', '' . "\0" . 'CYA\\YogaBundle\\Entity\\Inscripta' . "\0" . 'nota', '' . "\0" . 'CYA\\YogaBundle\\Entity\\Inscripta' . "\0" . 'comentario', '' . "\0" . 'CYA\\YogaBundle\\Entity\\Inscripta' . "\0" . 'fechains'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Inscripta $proxy) {
    ...
    public function setFechains($fechains = NULL)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setFechains', [$fechains]);

        return parent::setFechains($fechains);
    }
    ...
    public function getFechains()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getFechains', []);

        return parent::getFechains();
    }
