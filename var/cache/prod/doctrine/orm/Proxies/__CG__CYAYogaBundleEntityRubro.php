 ...
 */
class Rubro extends \CYA\YogaBundle\Entity\Rubro implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'movimientos', '' . "\0" . 'CYA\\YogaBundle\\Entity\\Rubro' . "\0" . 'id', '' . "\0" . 'CYA\\YogaBundle\\Entity\\Rubro' . "\0" . 'nombre', '' . "\0" . 'CYA\\YogaBundle\\Entity\\Rubro' . "\0" . 'tipo', '' . "\0" . 'CYA\\YogaBundle\\Entity\\Rubro' . "\0" . 'isActive'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Rubro $proxy) {
