 ...
 */
class Stock extends \CYA\YogaBundle\Entity\Stock implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'producto', 'usuario', '' . "\0" . 'CYA\\YogaBundle\\Entity\\Stock' . "\0" . 'id', '' . "\0" . 'CYA\\YogaBundle\\Entity\\Stock' . "\0" . 'fechainicio', '' . "\0" . 'CYA\\YogaBundle\\Entity\\Stock' . "\0" . 'comentario', '' . "\0" . 'CYA\\YogaBundle\\Entity\\Stock' . "\0" . 'cantidad'];
        }
