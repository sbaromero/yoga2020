 ...
 */
class Materia extends \CYA\YogaBundle\Entity\Materia implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'curso', '' . "\0" . 'CYA\\YogaBundle\\Entity\\Materia' . "\0" . 'id', '' . "\0" . 'CYA\\YogaBundle\\Entity\\Materia' . "\0" . 'titulo', '' . "\0" . 'CYA\\YogaBundle\\Entity\\Materia' . "\0" . 'comentario'];
        }
