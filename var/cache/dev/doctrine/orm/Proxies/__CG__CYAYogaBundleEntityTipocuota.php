 ...
 */
class Tipocuota extends \CYA\YogaBundle\Entity\Tipocuota implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'usuarios', '' . "\0" . 'CYA\\YogaBundle\\Entity\\Tipocuota' . "\0" . 'id', '' . "\0" . 'CYA\\YogaBundle\\Entity\\Tipocuota' . "\0" . 'nombre', '' . "\0" . 'CYA\\YogaBundle\\Entity\\Tipocuota' . "\0" . 'valor', '' . "\0" . 'CYA\\YogaBundle\\Entity\\Tipocuota' . "\0" . 'escurso', '' . "\0" . 'CYA\\YogaBundle\\Entity\\Tipocuota' . "\0" . 'mensaje'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Tipocuota $proxy) {
    ...
    public function setEsCurso($escurso)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setEsCurso', [$escurso]);

        return parent::setEsCurso($escurso);
    }
    ...
    public function getEsCurso()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getEsCurso', []);

        return parent::getEsCurso();
    }
