 ...
 */
class Maestroventa extends \CYA\YogaBundle\Entity\Maestroventa implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'movimiento', 'alumnocc', 'detalleventas', '' . "\0" . 'CYA\\YogaBundle\\Entity\\Maestroventa' . "\0" . 'id', '' . "\0" . 'CYA\\YogaBundle\\Entity\\Maestroventa' . "\0" . 'fecha', '' . "\0" . 'CYA\\YogaBundle\\Entity\\Maestroventa' . "\0" . 'tipopago', '' . "\0" . 'CYA\\YogaBundle\\Entity\\Maestroventa' . "\0" . 'total'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Maestroventa $proxy) {
