...
class MateriaController extends Controller
{
    ...
    public function addAction(Request $request)
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
                ...
                $this->addFlash('success', 'Nueva Materia creada');
   ...
   public function editAction($id, Request $request)
   {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            $this->addFlash('success', 'El materia ha sido modificada');
 ...
 public function deleteAction($id, Request $request)
    { 
       try{ $em = $this->getDoctrine()->getManager();
        ...
        $em->remove($materia);
        $em->flush();  
        $successMessage = 'Materia eliminada';
        $this->addFlash('success', $successMessage);
       }
        catch (\Exception $e) {
           $this->addFlash('error', 'Imposible eliminar esta Materia, verifique que no tenga alumnos inscriptos.');
            }
