 ...
 * Inscripta
 *
 * @ORM\Table(name="inscripta")
 * @ORM\Entity(repositoryClass="CYA\YogaBundle\Repository\InscriptaRepository")
...
class Inscripta
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="Materia", inversedBy="inscripta")
    ...
    /**
     * @ORM\ManyToOne(targetEntity="Usuario", inversedBy="inscripta")
